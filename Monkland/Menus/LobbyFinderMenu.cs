...
namespace Monkland.Menus
{
    internal class LobbyFinderMenu : Menu.Menu, SelectOneButton.SelectOneButtonOwner, CheckBox.IOwnCheckBox
    {
        ...
        public LobbyFinderMenu(ProcessManager manager) : base(manager, ProcessManager.ProcessID.MainMenu)
        {
            ...
            this.eyesRed.nextSelectable[0] = this.maxPlayersSlider;
            ...
            this.eyesGreen.nextSelectable[0] = this.maxPlayersSlider;
            ...
            this.eyesBlue.nextSelectable[0] = this.maxPlayersSlider;
            this.eyesBlue.nextSelectable[1] = this.eyesGreen;
            this.eyesBlue.nextSelectable[3] = this.slugcatButtons[0];
            this.eyesBlue.nextSelectable[2] = this.modeButtons[1];
            this.slugcatButtons[0].nextSelectable[0] = this.maxPlayersSlider;
            this.slugcatButtons[0].nextSelectable[1] = this.eyesBlue;
            this.slugcatButtons[0].nextSelectable[3] = this.slugcatButtons[1];
            this.slugcatButtons[0].nextSelectable[2] = this.backButton;
            this.slugcatButtons[1].nextSelectable[0] = this.maxPlayersSlider;
            ...
            this.slugcatButtons[2].nextSelectable[0] = this.maxPlayersSlider;
            ...
            this.startLobbyButton.nextSelectable[1] = this.maxPlayersSlider;
            ...
            this.maxPlayersSlider.nextSelectable[3] = this.startLobbyButton;
